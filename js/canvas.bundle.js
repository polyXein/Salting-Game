...
var backgroundImage = createImage(_assets_background_png__WEBPACK_IMPORTED_MODULE_2__["default"]);
var hillsImage = createImage(_assets_hills_png__WEBPACK_IMPORTED_MODULE_1__["default"]);
var smallTall = createImage(_assets_platformSmallTall_png__WEBPACK_IMPORTED_MODULE_3__["default"]);
/* class intance and new objects */
...
function init() {
  ...
  backgroundImage = createImage(_assets_background_png__WEBPACK_IMPORTED_MODULE_2__["default"]);
  hillsImage = createImage(_assets_hills_png__WEBPACK_IMPORTED_MODULE_1__["default"]);
  /* objects instance */

  player = new Player();
  platforms = [new Platform({
    x: platformImage.width * 4 + 10 - 2 + platformImage.width - smallTall.width,
    y: 270,
    image: smallTall
  }), new Platform({
  ...
  genericObjects = [new GenericObject({
    ...
    x: hillsImage.width * 2 + 100,
    y: -1,
    image: hillsImage
  }), new GenericObject({
    x: hillsImage.width * 4 + 400,
    y: -1,
    image: hillsImage
  }), new GenericObject({
    x: hillsImage.width * 6 + 500,
    y: -1,
    image: hillsImage
  })];
  scrollOffset = 0;
...
function animate() {
  ...
  /* srite switching condicional */

  if (keys.right.pressed && lastKey === 'right' && player.currentSprite !== player.sprites.run.right) {
    player.frames = 1;
    player.currentSprite = player.sprites.run.right;
    player.currentCropWhidth = player.sprites.run.cropWidth;
    ...
    player.currentCropWhidth = player.sprites.stand.cropWidth;
